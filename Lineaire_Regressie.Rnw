...
geg$uhat <- geg$y - geg$yhat
geg$ux <- geg$x*geg$uhat
tabel <- geg
...
qqnorm(geg$uhat, main="normaalplot", xlab="theoretische quantielen", ylab="steekproef quantielen")
qqline(geg$uhat)
@
