...
De controle of $E(U_{i})=0$ komt dus neer op de controle $E(U)=0$. De beste schatter daarvoor is $E(u_{i})$ en deze is, bij een lineair verband en gebruik van de kleinste kwadraten methode steeds gelijk aan nul. \underline{Samenvatting}: hier valt niet te veel te controleren. 
